...
export const MetricCards = () => {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-5 mb-5 md:mb-6">
      <div className="bg-white p-4 md:p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
      ...
      <div className="bg-white p-4 md:p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-3 md:mb-4 relative z-10">
          ...
          <span className="flex items-center text-xs font-medium text-rose-600 bg-rose-50 px-2 py-1 rounded-md">
            <i className="ph ph-warning-circle mr-1"></i> 5 Urgent
          </span>
        </div>
        <div className="relative z-10">
      ...
      <div className="bg-white p-4 md:p-5 rounded-2xl border border-rose-200 shadow-sm relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-3 md:mb-4 relative z-10">
          ...
          <span className="flex items-center text-xs font-medium text-rose-600 animate-pulse">
            <i className="ph-fill ph-circle text-[8px] mr-1.5"></i> Need Action
          </span>
        </div>
        <div className="relative z-10">
      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-4 md:p-5 rounded-2xl border border-slate-700 shadow-md relative overflow-hidden group">
