  ...
  <header className="fixed top-0 w-full z-50 border-b border-white/5 bg-black/50 backdrop-blur-md">
    <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link href="/register" className="px-4 py-2 bg-white text-black text-sm font-bold hover:bg-zinc-200 transition-colors">
          Coba Gratis
        </Link>
      </div>
    </div>
...
const ChatAnimation = () => {
  return (
    <div className="w-full max-w-md mx-auto border border-white/5 bg-black p-6 relative overflow-hidden h-[400px] flex flex-col justify-end">
      {/* Background elements */}
      ...
      <div className="relative z-10 flex flex-col gap-4 w-full">
        ...
        >
          <div className="bg-zinc-900 border border-white/5 p-4 text-sm text-zinc-300">
        ...
        <motion.div
          ...
          transition={{ duration: 2, delay: 1.5, times: [0, 0.2, 0.8, 1] }}
          className="self-end max-w-[80%] flex items-center gap-1 p-4"
        >
        ...
        >
          <div className="bg-zinc-800 border border-white/10 p-4 text-sm text-white">
            Tentu Bapak! Untuk Brio bulan Juni ada DP ringan 15 Juta. Angsuran mulai 3 jutaan. Mau dibantu hitung simulasi kreditnya?
          </div>
  ...
  return (
    <div className={`relative min-h-screen bg-black text-white selection:bg-white selection:text-black font-sans`}>
      ...
      <main className="pt-32 pb-24 flex flex-col">
        ...
        <section className="relative px-6 max-w-7xl mx-auto w-full min-h-[80vh] flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-24 pt-10">
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <Link
                  href="/register"
                  className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-black text-sm font-bold hover:bg-zinc-200 transition-colors w-full sm:w-auto"
                >
          ...
          <div className="flex-1 w-full relative z-10 flex justify-center lg:justify-end">
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-white/5 blur-[100px] pointer-events-none" />
              <ChatAnimation />
            </motion.div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-1 relative z-10 bg-white/5 border border-white/5">
            {[
              ...
              },
              {
                ...
                title: "Capek ketik ulang harga OTR & simulasi?",
                desc: "Setiap hari harus hitung DP dan angsuran manual yang makan waktu berjam-jam."
              }
            ].map((item, i) => (
              <motion.div
                key={i}
                ...
                className="bg-black p-10 flex flex-col items-center text-center group hover:bg-zinc-950 transition-colors"
              >
        ...
        <section id="features" className="px-6 py-32 w-full bg-zinc-950 border-y border-white/5">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-32">
              ...
              <div className="flex flex-col md:flex-row gap-16 items-center">
                ...
                <div className="flex-1 w-full bg-black border border-white/10 aspect-video p-8 relative overflow-hidden group">
              ...
              <div className="flex flex-col md:flex-row-reverse gap-16 items-center">
                ...
                <div className="flex-1 w-full bg-black border border-white/10 aspect-video p-8 relative overflow-hidden group">
                    <div className="w-full h-full border border-red-500/20 bg-red-500/5 flex items-center justify-center relative">
                        ...
                        <div className="text-center">
                           <div className="text-white text-sm border border-white/10 p-3 bg-black inline-block mb-4">&quot;Bisa kasih diskon 100 juta gak?&quot;</div>
               ...
               <div className="flex flex-col md:flex-row gap-16 items-center">
                ...
                <div className="flex-1 w-full bg-black border border-white/10 aspect-video p-6 relative overflow-hidden">
        ...
        <section id="pricing" className="px-6 py-32 max-w-5xl mx-auto w-full">
          <div className="text-center mb-16">
            ...
            <div className="inline-flex items-center p-1 bg-white/5 border border-white/10">
              <button
                ...
                className={`px-6 py-2 text-sm font-medium transition-colors ${!isYearly ? 'bg-white text-black' : 'text-zinc-400 hover:text-white'}`}
              >
                Bulanan
              </button>
              <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div
               ...
               whileInView={{ opacity: 1, y: 0 }}
               viewport={{ once: true }}
               className="border border-white/10 bg-black/50 backdrop-blur-sm p-10 flex flex-col relative group hover:border-white/30 transition-colors"
            >
            ...
            >
              <div className="absolute top-0 right-8 -translate-y-1/2 bg-white text-black text-xs font-bold px-3 py-1 tracking-widest uppercase">
                Rekomendasi
              </div>
              ...
              <Link href="/register" className="w-full py-4 bg-white text-black text-center text-sm font-bold hover:bg-zinc-200 transition-colors">
                Hubungi Sales
              </Link>
            </motion.div>
          </div>
